"""
Django settings for dchresults project.
...
SECRET_KEY = 'django-insecure-zi#g(y_-*ihb6*az4ktdq(y_$2e7_gup&jw!r48lke_85-aa4+'
...
WSGI_APPLICATION = 'dchresults.wsgi.application'
